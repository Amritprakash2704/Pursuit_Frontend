        ...
        >
            ...
            <Box sx={style}>
                ...
                <Box sx={{
                    ...
                    <Box  sx={{
                            ...
                            {(modalData['rounds'])!=undefined? modalData.rounds.map((props)=>
                                <RoundCard round_name={props.round_name} round_type={props.round_type}></RoundCard>
                ...
                <Box sx={{
                    ...
                    <Button variant='outlined' startIcon={<DeleteIcon />} onClick={props.handleClose}>Delete</Button>
